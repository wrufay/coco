...
(() => {
    ...
    for (let l = n + 1; l < e.length; l++)
      if (((i = e.charCodeAt(l)), 92 === i)) l += 1;
        ...
        if (
          ...
          throw new r(
            `Unterminated string: ${
              e.slice(n, l + 1) + String.fromCharCode(o)
            }`,
            a ? [a, n, l + 1] : null
          );
          ...
          if (
            ...
            for (let e = 0; e < t.nodes.length; e++)
              0 != e || "word" !== t.nodes[e].kind
                ? B([t.nodes[e]])
                : (t.nodes[e].value = M(t.nodes[e].value, !0));
            break;
          }
  ...
  var de = {
    ...
    "line-width": function (e) {
      return Z(e, " ").every(
        (e) => Ae(e) || ke(e) || "thin" === e || "medium" === e || "thick" === e
      );
    },
    image: function (e) {
      let t = 0;
  ...
  function He(e, t, r, n, o = "") {
    ...
    return a
      ? [
          T(e, l(Oe(t, n))),
          C("@supports (color: lab(from red l a b))", [T(e, l(i))]),
        ]
      : [T(e, l(i))];
  }
  ...
  function at(e, t) {
    let r = (function (e) {
        ...
        let l = () =>
          K([
            De("--tw-border-spacing-x", "0", "<length>"),
            De("--tw-border-spacing-y", "0", "<length>"),
          ]);
        ...
        let f = () =>
          K([De("--tw-pan-x"), De("--tw-pan-y"), De("--tw-pinch-zoom")]);
        ...
        for (let [e, t] of [
          ...
          i(e, ["--scroll-margin", "--spacing"], (e) => [T(t, e)], {
            supportsNegative: !0,
          });
        for (let [e, t] of [
        ...
        {
          let a = `var(--tw-ease, ${
              e.resolve(null, ["--default-transition-timing-function"]) ??
              "ease"
            })`,
            i = `var(--tw-duration, ${
        ...
        let $ = () =>
          K([
            De("--tw-text-shadow-color"),
            De("--tw-text-shadow-alpha", "100%", "<percentage>"),
          ]);
            ...
            t.functional("shadow", (t) => {
              ...
              switch (t.value.value) {
                case "none":
                  return t.modifier
                    ? void 0
                    : [s(), T("--tw-shadow", l), T("box-shadow", i)];
                case "inherit":
                  return t.modifier
                    ? void 0
              ...
              }
              {
                ...
                if (r)
                  return [
                    s(),
                    T("--tw-shadow-color", _e(r, "var(--tw-shadow-alpha)")),
                  ];
              }
            }),
            r("shadow", () => [
            ...
            t.functional("inset-shadow", (t) => {
                    ...
                    null === n
                      ...
                      : [
                          ...
                          T(
                            ...
                            _e(n, "var(--tw-inset-shadow-alpha)")
                          ),
                        ])
                  : [
                      s(),
              ...
              switch (t.value.value) {
                case "none":
                  return t.modifier
                    ? void 0
                    : [s(), T("--tw-inset-shadow", l), T("box-shadow", i)];
                case "inherit":
                  return t.modifier
                    ? void 0
              ...
              }
              {
                ...
                if (r)
                  return [
                    ...
                    T(
                      "--tw-inset-shadow-color",
                      _e(r, "var(--tw-inset-shadow-alpha)")
                    ),
                  ];
              }
            }),
            ...
            let r = (function (e, t, r) {
              ...
              for (let r of n) {
                ...
                for (let r of e.variants)
                  if (null === st(l, r, t.variants)) return [];
  ...
  function ut(e) {
    for (let t of e)
      "at-root" !== t.kind &&
        ("declaration" === t.kind
          ? (t.important = !0)
          : ("rule" === t.kind || "at-rule" === t.kind) && ut(t.nodes));
  }
  function dt(e) {
    let t = new Set(),
      r = 0,
                  ...
                  if (r.length > 1) {
                    ...
                    if (t.candidatesToCss([n])[0]) {
                      ...
                      if (o.length > 0) {
                        if (1 === o.length)
                          throw new Error(
                            `Cannot apply utility class \`${e}\` because the ${o.map(
                              (e) => `\`${e}\``
                          ...
                          );
                        {
                          ...
                          throw new Error(
                            `Cannot apply utility class \`${e}\` because the ${t.format(
                              o.map((e) => `\`${e}\``)
      ...
      let r = 5;
      {
        ...
        n &&
          ...
          e.theme.add(
            ...
            mt(t.fontFamily.sans, "fontFeatureSettings") ?? "normal",
            r
          ),
          e.theme.add(
  ...
  function yt(e, t = [], r) {
    for (let n of Reflect.ownKeys(e)) {
      ...
      if (1 !== i) {
        if (2 === i) return 2;
        if ((Array.isArray(o) || "object" == typeof o) && 2 === yt(o, a, r))
          return 2;
      }
    }
  }
    ...
    return function (n, o) {
      ...
      let l = (() => {
        ...
        if (null !== l && "object" == typeof l && !Array.isArray(l)) {
          ...
          for (let t in a)
            "__CSS_VALUES__" !== t &&
              ((4 & l?.__CSS_VALUES__?.[t] && void 0 !== Nt(e, t.split("-"))) ||
                (e[s(t)] = a[t]));
          return e;
        }
    ...
    for (let [e, n] of r)
      if (null != n && !1 !== n)
        if ("object" != typeof n) {
          ...
          for (let r of n)
            "string" == typeof r ? t.push(T(e, r)) : t.push(C(e, Wt(r)));
  ...
  function tr(e, { config: t, base: r, path: n, reference: o, src: a }) {
    ...
    for (let i of t.presets ?? [])
      tr(e, { path: n, base: r, config: i, reference: o, src: a });
    for (let t of i)
      e.plugins.push(t),
        t.config &&
          tr(e, {
  ...
  function or(e) {
    return (Array.isArray(e) ? e : [e])
      .map((e) =>
        "string" == typeof e ? { min: e } : e && "object" == typeof e ? e : null
      )
      .map((e) => {
        if (null === e) return null;
      ...
      if ("@plugin" === e.name) {
        ...
        for (let t of e.nodes ?? []) {
          ...
          let e = Z(t.value, ",").map((e) => {
            ...
            if ("{" === e[0] && "}" === e[e.length - 1])
              throw new Error(
                `Unexpected \`@plugin\` option: Value of declaration \`${F([
                  t,
  ...
  async function pr(
    e,
    { base: t = "", from: r, loadModule: n = dr, loadStylesheet: o = fr } = {}
  ) {
    let a = 0;
    ...
    y(e, (e, t) => {
                        ...
                        if (
                          ...
                          console.warn(
                            `Unsupported bare value data type: "${
                              t.value
                            }".\nOnly valid data types are: ${Pe.map(
                              (e) => `"${e}"`
                            ).join(", ")}.\n`
                          );
                          let r = t.value,
      ...
      if ("@theme" === e.name) {
        ...
        return (
          ...
          h
            ? b.ReplaceSkip([])
            : ((h = z(":root, :host", [])), (h.src = e.src), b.ReplaceSkip(h))
        );
      }
    });
    let j = at(c, m?.src);
    if ((i && (j.important = i), $.length > 0))
      for (let e of $) j.invalidCandidates.add(e);
    a |= await ir({
      designSystem: j,
      base: t,
      ast: e,
  ...
  async function hr(t, r = {}) {
    let o = n(t, { from: r.from }),
      a = await (async function (e, t = {}) {
        ...
        n.unshift(
          j("! tailwindcss v4.1.18 | MIT License | https://tailwindcss.com ")
        );
        let u = new Set(),
          d = null,
          f = 0,
  ...
  async function Ar(e, t) {
    try {
      ...
      return (
        $r.hit("Loaded stylesheet", { id: e, base: t, size: r.content.length }),
        r
      );
    } catch (r) {
      throw (
        ($r.hit("Failed to load stylesheet", {
          id: e,
          base: t,
          error: r.message ?? r,
        }),
          ...
          await (async function (e) {
            ...
            $r.end("Collect classes", { count: t.size }),
              (0 !== t.size || "incremental" !== e) &&
                ($r.start("Build utilities"),
                (br.textContent = mr.build(Array.from(t))),
                $r.end("Build utilities"));
          })(e),
          $r.end("Build"),
          $r.end(`Build #${t} (${e})`);
      })
